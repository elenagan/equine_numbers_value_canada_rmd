...
```{r plot_horses, fig.width=10, fig.height=3, fig.cap="Historical Number of Horses", out.width='100%'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Maximum and Minumum Number of Horses per province")
```
...
```{r plot_province, fig.width=4, fig.height=4, fig.cap="Historical Number of Horses in Alberta", out.width='100%'}
